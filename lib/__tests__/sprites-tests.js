...
require('../globals')
const {curry, assoc, assocPath, dissoc, omit, pipeP} = require('ramda')
...
describe('Sprites', () => {
    ...
    describe('.withdraw', () => {
        ...
        describe('remaining amounts cooperatively after off-chain payment', () => {
            ...
            it.skip('using combined methods', async () => {
                const amt = 10
                ...
                const peek = tap(x => log(pick(['channel', 'before'], x)))
                ...
                expect(Alice2.channel).toHaveProperty('withdrawn', [amt - 3, 0])
